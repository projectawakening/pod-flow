...
library Inventory {
   ...
   * @notice Get items.
   */
  function get(uint256 smartObjectId) internal view returns (uint256[] memory items) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Get items.
   */
  function _get(uint256 smartObjectId) internal view returns (uint256[] memory items) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Set items.
   */
  function set(uint256 smartObjectId, uint256[] memory items) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Set items.
   */
  function _set(uint256 smartObjectId, uint256[] memory items) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function getItem(uint256 smartObjectId, uint256 _index) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function _getItem(uint256 smartObjectId, uint256 _index) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Push an element to items.
   */
  function push(uint256 smartObjectId, uint256 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Push an element to items.
   */
  function _push(uint256 smartObjectId, uint256 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Update an element of items at `_index`.
   */
  function update(uint256 smartObjectId, uint256 _index, uint256 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Update an element of items at `_index`.
   */
  function _update(uint256 smartObjectId, uint256 _index, uint256 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   */
  function encode(uint256[] memory items) internal pure returns (bytes memory, EncodedLengths, bytes memory) {
