...
library InventoryItem {
   ...
   */
  function set(uint256 smartObjectId, uint256 itemObjectId, bool exists, uint256 quantity, uint256 index) internal {
   ...
   * @notice Set the full data using individual values.
   */
  function _set(uint256 smartObjectId, uint256 itemObjectId, bool exists, uint256 quantity, uint256 index) internal {
    bytes memory _staticData = encodeStatic(exists, quantity, index);
   ...
   */
  function decodeStatic(bytes memory _blob) internal pure returns (bool exists, uint256 quantity, uint256 index) {
   ...
   */
  function encodeStatic(bool exists, uint256 quantity, uint256 index) internal pure returns (bytes memory) {
