...
// Define the GPC Proof Configuration for Inventory Verification
// this proof shows that a specific ship has a quantity >= 1 of one of the three item types
export const inventoryProofConfig: GPCProofConfig = {
